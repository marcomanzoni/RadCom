...
figure; imagesc(x_foc, y_foc, abs(I)); axis xy tight; title("SAR image without noise");
xlabel("x [m]"); ylabel("y [m]"); colorbar; colormap(lajolla);

figure; imagesc(x_foc, y_foc, abs(I_n)); axis xy tight; title("SAR image with noise");
xlabel("x [m]"); ylabel("y [m]"); colorbar; colormap(lajolla);
